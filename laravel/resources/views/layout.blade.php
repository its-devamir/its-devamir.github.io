                    ...
                    <div class="col-sm-6 offset-6">
                        <div class="header-top-link">
                            <ul class="quick-link">
                                ...
                                <li><a href="sign-up.html">عضویت</a></li>
                        ...
                        <ul class="action-list">
                            ...
                            <li class="my-account">
                                ...
                                <div class="my-account-dropdown">
                                    ...
                                    <div class="login-btn">
                                        <a href="sign-in.html" class="axil-btn btn-bg-primary">ورود</a>
                                    </div>
                                    <div class="reg-footer text-center">عضو سایت نیستید؟<a href=""
                                            class="btn-link">عضویت</a></div>
                                </div>
                            </li>
            ...
            <div class="card-header">
                <form action="#">
                    <div class="input-group">
                        <input type="text" class="form-control" name="prod-search" id="prod-search" onkeyup="searchProduct(this)" value="{{Request::get('search')}}"
                            placeholder="عبارت مورد نظر را جستجو کنید">
                        <button type="submit" class="axil-btn btn-bg-primary"><i class="far fa-search"></i></button>
                    </div>
                </form>
            </div>
            <div class="card-body" id="searchModalItems">
    ...
    <div class="cart-dropdown" id="cart-dropdown">
        <div class="cart-content-wrap">
            <div class="cart-header">
                <h2 class="header-title">سبد خرید</h2>
